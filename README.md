...
<html>
          ...
          <div class="text">
              <div class="column" style="margin-top: 80px">
                ...
                <p class="normal-text">Welcome to my portfolio.<br><br>
                    ...
                    I did throughout my life. Follow me with my journay as I
                    prepare to graduate from high school in 2022.
                </p>

                <div class="about-me">
                    <h1 class="header">.about-me</h1>
                    <p class="normal-text">
                        I am currently a Grade 12 STEM student at De La Salle Santiago Zobel.
                        ...
                        in the medical field. In my free time, I like reading books and watching film.<br><br>
    ...
    <footer>
        <p>Built and designed by Sydelle Mago.</p>
